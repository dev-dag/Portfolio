...
public class Dagger : Weapon
{
            ...
            .Do(string.Empty, (t) =>
            {
                ...
                else if (skillAction.IsPressed()) // 입력이 있는 경우
                {
                        ...
                        && player.CurrentAnimationState != Player.AnimationState.Attack_2)
                    {
                        ...
                        skill_1.TryOperateWithFollow(player.transform, player.transform.rotation, LayerMask.NameToLayer(GameManager.PLAYER_EXCLUSIVE_LAYER_NAME), player); // 스킬 시전 시도
                        return BehaviourTreeStatus.Success;
                    }
                    else
                    {
    ...
    private const float DASH_POW = 60f;
                ...
                else if (skillAction.IsPressed()) // 입력이 있는 경우
                {
                        ...
                        && player.CurrentAnimationState != Player.AnimationState.Attack_1)
                    {
                        ...
                        // Progress
                        {
                            ...
                            {
                                player.RigidBody.linearVelocityX = DASH_POW;
                            }
